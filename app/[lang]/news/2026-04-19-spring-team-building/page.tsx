...
export default function SpringTeamBuilding20260419Page() {
          ...
          <div className="row g-5 align-items-center mb-5">
            <div className="col-md-6 wow fadeIn" data-wow-delay="0.5s">
              ...
              <h1 className="display-6 mb-3">
                {t("page.news.20260419-spring-team-building.title")}
              </h1>

              {/* 正文段落 */}
              <p className="news-paragraph news-paragraph--dropcap">
                {t("page.news.20260419-spring-team-building.p1")}
              </p>

              <p className="news-paragraph news-paragraph--indent">
                {t("page.news.20260419-spring-team-building.p2")}
              </p>
              ...
              <p className="news-paragraph news-paragraph--indent">
                {t("page.news.20260419-spring-team-building.p3")}
              </p>

              <p className="news-paragraph news-paragraph--highlight-brand">
                {t("page.news.20260419-spring-team-building.p4")}
              </p>

              <p className="news-paragraph news-paragraph--indent">
                {t("page.news.20260419-spring-team-building.p5")}
              </p>
              ...
              <p className="news-paragraph news-paragraph--indent">
                {t("page.news.20260419-spring-team-building.p6")}
              </p>
              ...
              <p className="news-paragraph news-paragraph--indent">
                {t("page.news.20260419-spring-team-building.p7")}
              </p>
              ...
              <p className="news-paragraph news-paragraph--indent-with-line">
                {t("page.news.20260419-spring-team-building.p8")}
              </p>
